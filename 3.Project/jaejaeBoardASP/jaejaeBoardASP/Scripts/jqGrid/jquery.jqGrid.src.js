...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		addRowNum = function (pos,irow,pG,rN) {
			...
			return "<td scope=\"row\" role=\"gridcell\" class=\"ui-state-default jqgrid-rownum\" "+prp+">"+v+"</td>";
		},
		...
		for(i=0;i<this.p.colNames.length;i++){
			...
			thead += "<th id='"+ts.p.id+"_"+ts.p.colModel[i].name+"' scope='col' role='columnheader' class='ui-state-default ui-th-column ui-th-"+dir+"'"+ tooltip+">";
			...
			this.each(function() {
				...
				while(k < datalen) {
					...
					if(ni){
						...
						row[row.length] = "<td scope=\"row\" role=\"gridcell\" class=\"ui-state-default jqgrid-rownum\" "+prp+">0</td>";
					}
					if(gi) {
